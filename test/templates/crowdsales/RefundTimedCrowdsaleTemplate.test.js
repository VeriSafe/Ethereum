...
const RefundTimedCrowdsaleTemplate = artifacts.require('RefundTimedCrowdsaleTemplate');
const BurnERC20Template = artifacts.require('BurnERC20Template');

contract('RefundableTimedCrowdsale', function ([_, wallet, investor, purchaser, owner, anyone]) {
