...
contract TokenRefundEscrow is TokenConditionalEscrow {
    ...
    */
    constructor(address beneficiary, IERC20 token)
     public
     TokenEscrow(token)
     {
    ...
    */
    function deposit(address refundee, uint256 amount) public {
        require(_state == State.Active);
        super.deposit(refundee, amount);
    }
    ...
    */
    function beneficiaryWithdraw() public {
        ...
        token().safeTransfer(_beneficiary, token().balanceOf(address(this)));
    }
